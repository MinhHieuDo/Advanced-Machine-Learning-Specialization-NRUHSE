...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        # best_thread1, dist1 = pairwise_distances_argmin_min(question_vec, thread_embeddings[:n, :], metric='cosine')
        # best_thread2, dist2 = pairwise_distances_argmin_min(question_vec, thread_embeddings[n:, :], metric='cosine')
        # if dist1[0] <= dist2[0]:
